module.exports = {
	...
	name: "Pobierz dane uzytkownika lista",
...
<br>
	...
	<option value="username"selected>Nazwa uzytkownika</option>
	</select>
    <br>
	...
	<option value="result" selected>Wynik</option>
   ...
   <option value="0" selected>Nie sortuj</option>
   <option value="1" selected>Sortuj malejaco</option>
   <option value="2">Sortuj rosnaco</option>
</select><br>
	...
	Limit wynikow:
	<input id="getresults" class="round" type="text" placeholder="Jesli puste - wszystkie wyniki">
</div><br><br><br>
...
<option value="0" selected>Debuguj</option>
<option value="1" selected>Nie debuguj</option>
