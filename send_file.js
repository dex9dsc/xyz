...
<div style="padding-top: 8px;">
	URL pliku lokalnego:<br>
	<input id="file" class="round" type="text" value="resources/"><br>
</div>
<div>
	Wiadomosc:<br>
	<textarea id="message" rows="8" placeholder="Wpisz wiadomosc tutaj..." style="width: 99%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
</div>`
},
