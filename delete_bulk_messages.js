...
name: "Masowe usuwanie wiadomosci",
...
<div style="padding-top: 8px;">
	Ilosc wiadomosci do usuniecia:<br>
	<input id="count" class="round" type="text" style="width: 90%;"><br>
</div>
<div>
	<div style="float: left; width: 35%;">
		Warunek usuniecia:<br>
		<select id="condition" class="round" onchange="glob.onChange2(this)">
			<option value="0" selected>Zaden</option>
			<option value="1">Wiadomosc autora</option>
			<option value="2">Do wyboru</option>
		</select>
	</div>
