...
<div style="float: right; width: 50%;">
	...
	<input id="volume" class="round" type="text" placeholder="Zostaw puste aby uzupełnić automatycznie"><br>
	Szybkość Transmisji:<br>
	<input id="bitrate" class="round" type="text" placeholder="Zostaw puste aby uzupełnić automatycznie">
</div><br><br><br><br><br><br><br>
<div>
	Typ Piosenki:<br>
	<select id="type" class="round" style="width: 90%;">
		<option value="0" selected>Dodaj do Kolejki</option>
		<option value="1">Graj Niezależnie</option>
	</select>
</div>`
},
